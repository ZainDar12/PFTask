...
int main(){
    ...
    scanf("%d %s %d %s %d %s %d %s %d %s %d %s %d %s %d %s",&Spending1,TransactionID1,&Time1,TCountry1,
        ...
        ,&Spending4,TransactionID4,&Time4,TCountry4);
    if (Spending1 > DailySpendingLimit) {
    ...
    if (strcmp(TCountry1, country1) != 0 && strcmp(TCountry1, country2) != 0){
    ...
    if (Time2-Time1<100 || Time3-Time2<100 || Time4-Time3<100){
